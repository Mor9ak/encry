...
const Footer = () => {
    return (
        <footer className={"bg-elementsBg justify-center p-7 rounded-lg items-center text-center m-7"}>
            ...
            <div className="flex *:shadow-xl/30 justify-center *:mx-7 *:text-secondaryText *:p-3 *:rounded-lg cursor-pointer">
